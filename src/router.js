...
const router = new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      component: Location,
      meta: {
        title: "Location - Steven Xie",
        metaTags: [
          {
            name: "description",
            content:
              "Request current location data and recent location history.",
          },
        ],
      },
    },
...
//
// Stolen from: https://alligator.io/vuejs/vue-router-modify-head/
router.beforeEach((to, from, next) => {
  ...
  // Remove any stale meta tags from the document using the key attribute we set
  // below.
